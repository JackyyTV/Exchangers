...
public class ItemDarkSteelExchanger extends ItemExchangerBaseRF {

	public ItemDarkSteelExchanger() {
		setRegistryName(Data.MODID + ":dark_steel_exchanger");
		setUnlocalizedName(Data.MODID + ".dark_steel_exchanger");
		setMaxStackSize(1);
