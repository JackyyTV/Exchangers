...
public class ItemEliteExchanger extends ItemPoweredExchanger {

	public ItemEliteExchanger() {
		setRegistryName(Data.MODID + ":elite_exchanger");
		setUnlocalizedName(Data.MODID + ".elite_exchanger");
		setMaxStackSize(1);
	...
	public int getMaxEnergyStored(ItemStack container) {
		return Config.eliteExchangerMaxRF;
	}
	...
	public void getSubItems(CreativeTabs tab, NonNullList<ItemStack> list) {
		...
		EnergyHelper.setDefaultEnergyTag(full, Config.eliteExchangerMaxRF);
		list.add(full);
	}
