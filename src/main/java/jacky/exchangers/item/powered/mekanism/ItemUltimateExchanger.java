...
public class ItemUltimateExchanger extends ItemPoweredExchanger {

	public ItemUltimateExchanger() {
		setRegistryName(Data.MODID + ":ultimate_exchanger");
		setUnlocalizedName(Data.MODID + ".ultimate_exchanger");
		setMaxStackSize(1);
	...
	public int getMaxEnergyStored(ItemStack container) {
		return Config.ultimateExchangerMaxRF;
	}
	...
	public void getSubItems(CreativeTabs tab, NonNullList<ItemStack> list) {
		...
		EnergyHelper.setDefaultEnergyTag(full, Config.ultimateExchangerMaxRF);
		list.add(full);
	}
