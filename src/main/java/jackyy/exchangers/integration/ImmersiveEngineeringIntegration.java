...
public class ImmersiveEngineeringIntegration {
    ...
    public static void init() {
        ...
        Block capBlock = Block.REGISTRY.getObject(new ResourceLocation(Exchangers.IE, "metal_device0"));
        lvCapacitor = new ItemStack(capBlock, 1, 0);
        mvCapacitor = new ItemStack(capBlock, 1, 1);
        hvCapacitor = new ItemStack(capBlock, 1, 2);

        Block engBlock = Block.REGISTRY.getObject(new ResourceLocation(Exchangers.IE, "metal_decoration0"));
