...
@Config(modid = Exchangers.MODID, name = "Exchangers")
    ...
    public static class ConfigHolder {
        ...
        public static Configuration getConfig() {
            if (config == null) {
                try {
                    ...
                    Exchangers.logger.error("Failed to get Configuration instance!", throwable);
                }
            }
            return config;
        }
        ...
        public static void onConfigChanged(ConfigChangedEvent.OnConfigChangedEvent event) {
            if (event.getModID().equals(Exchangers.MODID)) {
                ConfigManager.load(Exchangers.MODID, Config.Type.INSTANCE);
            }
        }
    }
