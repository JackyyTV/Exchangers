...
public class ModConfigs {
    ...
    public static class CommonConfig {
        ...
        public final ForgeConfigSpec.IntValue netheriteMaxHarvestLevel;
        ...
        CommonConfig(ForgeConfigSpec.Builder builder) {
            ...
            netheriteMaxHarvestLevel = builder
                    .comment("Set the max harvest level for Netherite Exchanger")
                    .defineInRange("netheriteExchangerMaxHarvestLevel", DefaultValues.netheriteMaxHarvestLevel, 0, Integer.MAX_VALUE);
