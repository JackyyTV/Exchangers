...
public class RecipeHelper {
    ...
    public static IRecipe addRecipe(int j, IRecipe rec){
        CraftingManager.func_193372_a(new ResourceLocation(Exchangers.MODID, "recipes" + j), rec);
        return rec;
    }
    /*
    ...
    public static ShapedRecipes genShaped(ItemStack output, int l, int w, Object[] input){
        if(l * w != input.length) throw new UnsupportedOperationException("Attempted to add invalid shaped recipe. Please contact the author of Exchangers.");
    ...
    public static NonNullList<Ingredient> createInput(Object[] input){
        ...
        for(int i = 0; i < input.length; i++){
            ...
            if(k instanceof String){
                ...
                throw new UnsupportedOperationException("Attempted to add invalid shapeless recipe. Please contact the author of Exchangers.");
            }
        }
        return inputL;
    }
