...
public class GUIHandler extends Gui {
	...
	if (player.inventory.func_194015_p() != lastInvDirtyNum || this.lastExchangeSource == null
	    ...
	    lastInvDirtyNum = player.inventory.func_194015_p();
	}
	...
	if (!player.capabilities.isCreativeMode)
	    drawItemQuantity(mc.fontRenderer, xOffset + 1, yOffset + 1, am);
	else
	    drawItemQuantity(mc.fontRenderer, xOffset + 1, yOffset + 1, "Inf");
