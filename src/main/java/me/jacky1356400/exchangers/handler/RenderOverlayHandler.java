...
public class RenderOverlayHandler {
	...
	public void RenderWorldLastEvent(RenderWorldLastEvent event) {
		...
		if (stack != null && stack.getItem() instanceof ExchangerHandler && stack.getTagCompound() != null
				&& mouseOver != null && mouseOver.getBlockPos() != null && mouseOver.sideHit != null) {
			List<BlockPos> blocks = ExchangerHandler.getBlocksToExchange(stack, mouseOver.getBlockPos(), world,
