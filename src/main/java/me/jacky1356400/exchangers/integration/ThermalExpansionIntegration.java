...
public class ThermalExpansionIntegration {
    ...
    public static void init() {
        ...
        bucketEnergizedGlowstone = UniversalBucket.getFilledBucket(ForgeModContainer.getInstance().universalBucket, glowstone);
        Fluid cryotheum = FluidRegistry.getFluid("cryotheum");
        bucketGelidCryotheum = UniversalBucket.getFilledBucket(ForgeModContainer.getInstance().universalBucket, cryotheum);
    }
}
