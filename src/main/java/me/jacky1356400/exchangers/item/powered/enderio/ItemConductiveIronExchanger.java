...
public class ItemConductiveIronExchanger extends ItemPoweredExchanger {

	public ItemConductiveIronExchanger() {
		setRegistryName(Data.MODID + ":conductive_iron_exchanger");
		setUnlocalizedName(Data.MODID + ".conductive_iron_exchanger");
		setMaxStackSize(1);
