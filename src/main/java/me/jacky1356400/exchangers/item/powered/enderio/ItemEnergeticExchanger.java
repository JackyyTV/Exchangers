...
public class ItemEnergeticExchanger extends ItemPoweredExchanger {

	public ItemEnergeticExchanger() {
		setRegistryName(Data.MODID + ":energetic_exchanger");
		setUnlocalizedName(Data.MODID + ".energetic_exchanger");
		setMaxStackSize(1);
