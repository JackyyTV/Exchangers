...
public class ItemPulsatingIronExchanger extends ItemPoweredExchanger {

	public ItemPulsatingIronExchanger() {
		setRegistryName(Data.MODID + ":pulsating_iron_exchanger");
		setUnlocalizedName(Data.MODID + ".pulsating_iron_exchanger");
		setMaxStackSize(1);
