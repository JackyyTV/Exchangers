...
public class ItemHardenedExchanger extends ItemPoweredExchanger {

	public ItemHardenedExchanger() {
		setRegistryName(Data.MODID + ":hardened_exchanger");
		setUnlocalizedName(Data.MODID + ".hardened_exchanger");
		setMaxStackSize(1);
