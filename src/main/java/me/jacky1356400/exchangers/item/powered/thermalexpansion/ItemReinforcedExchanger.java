...
public class ItemReinforcedExchanger extends ItemPoweredExchanger {

	public ItemReinforcedExchanger() {
		setRegistryName(Data.MODID + ":reinforced_exchanger");
		setUnlocalizedName(Data.MODID + ".reinforced_exchanger");
		setMaxStackSize(1);
	...
	public int getMaxEnergyStored(ItemStack container) {
		return Config.reinforcedExchangerMaxRF;
	}
	...
	public void getSubItems(CreativeTabs tab, NonNullList<ItemStack> list) {
		...
		EnergyHelper.setDefaultEnergyTag(full, Config.reinforcedExchangerMaxRF);
		list.add(full);
	}
